Use established application terminology exactly.
Do not substitute these with invented alternatives.

| Concept                          | Required Term      | Do Not Use                                |
| -------------------------------- | ------------------ | ----------------------------------------- |
| Person completing an induction   | Inductee           | Employee, Applicant, Trainee              |
| Learning requirement             | Induction          | Course, Training                          |
| Assessment                       | Exam               | Test, Quiz                                |
| Individual assessment submission | Exam Attempt       | Exam Record, Exam Submission              |
| Compliance credential            | Compliance Record  | Certification Record, Completion Record   |
